    ...
    companion object {
        val demoChannels = listOf(
            Channel(
                ...
                lastPostTime = PlatformTime.currentTimeMillis() - 3600000,
                unreadCount = 0,
                isVerified = true
            ),
            Channel(
                ...
                lastPostTime = PlatformTime.currentTimeMillis() - 7200000,
                unreadCount = 1,
                isVerified = true
            ),
            Channel(
                ...
                lastPostTime = PlatformTime.currentTimeMillis() - 14400000,
                unreadCount = 2,
                isVerified = true
            ),
            Channel(
                ...
                lastPostTime = PlatformTime.currentTimeMillis() - 86400000,
                unreadCount = 0,
                isVerified = false
            ),
            Channel(
                ...
                lastPostTime = PlatformTime.currentTimeMillis() - 259200000,
                unreadCount = 0,
                isVerified = true
            ),
            Channel(
                ...
                lastPostTime = PlatformTime.currentTimeMillis() - 10800000,
                unreadCount = 3,
                isVerified = false
            ),
            Channel(
                ...
                lastPostTime = PlatformTime.currentTimeMillis() - 432000000,
                unreadCount = 0,
                isVerified = false
            ),
            Channel(
                ...
                lastPostTime = PlatformTime.currentTimeMillis() - 1800000,
                unreadCount = 5,
                isVerified = false
            )
        )
