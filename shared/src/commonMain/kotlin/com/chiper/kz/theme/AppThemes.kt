...
val SunsetTheme = AppTheme(
    ...
    lightColors = SunsetLightColors,
    darkColors = SunsetDarkColors,
    gradientColors = SunsetGradient
)
...
val ForestTheme = AppTheme(
    ...
    lightColors = ForestLightColors,
    darkColors = ForestDarkColors,
    gradientColors = ForestGradient
)

val SpaceTheme = AppTheme(
    id = "space",
    name = "Космос",
    description = "Глубинные космические тона",
    lightColors = SpaceLightColors,
    darkColors = SpaceDarkColors,
    gradientColors = SpaceGradient
)

val NeonTheme = AppTheme(
    id = "neon",
    name = "Неон",
    description = "Яркие неоновые акценты",
    lightColors = NeonLightColors,
    darkColors = NeonDarkColors,
    gradientColors = NeonGradient
)

val AuroraTheme = AppTheme(
    id = "aurora",
    name = "Аврора",
    description = "Северное сияние",
    lightColors = AuroraLightColors,
    darkColors = AuroraDarkColors,
    gradientColors = AuroraGradient
)